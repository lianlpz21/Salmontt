...
Aplicación desarrollada en Java para la empresa Salmontt, donde se aplican conceptos de Programación Orientada a Objetos como encapsulamiento, herencia, polimorfismo, interfaces, uso de instanceof, manejo de colecciones y lectura de archivos .txt.
